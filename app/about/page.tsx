...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-gray-900 text-white p-8 md:p-60">
      <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-12">
        
        
        <div className="relative w-60 h-80 md:w-80 md:h-80">
          <Image
            src={aboutPhoto}
        ...
        <div className="flex-1 space-y-4">
          ...
          <div className="flex gap-4">
            <Link href={"/category"}> <button className="bg-purple-600 hover:bg-purple-700 px-6 py-2 rounded-lg font-medium transition">
              My Projects
            </button></Link>
